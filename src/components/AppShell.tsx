    ...
    <div className={`app-shell accent-${accent}`}>
      <aside className="app-sidebar">
        ...
        <div className="shell-sidebar-bottom">
          ...
          <div className="shell-bottom-row">
            <div
              className={`ring-connection ${source === "oura" ? "live" : ""}`}
            >
              <span className="ring-connection-icon" aria-hidden="true" />
              <div>
                <strong>Oura Ring</strong>
                <small>{sourceText(source, status)}</small>
              </div>
            </div>
            <Link
              to="/motion-visualizer"
              className="shell-diagnostics"
              aria-label="Open motion diagnostics"
            >
              ⚙
            </Link>
          </div>
      ...
      <div className="app-content">
        <div className="mobile-shell-bar">
          <Link className="shell-brand compact" to="/">
            <span className="shell-brand-mark">
              <i />
              <b />
            </span>
            <strong>Oura Motion Controller</strong>
          </Link>
