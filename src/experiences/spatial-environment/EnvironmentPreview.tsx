...
export function EnvironmentPreview({ temperature, atmosphere }: Props) {
  return (
    <aside className="environment-preview">
      <p>Current temperature</p>
      <h2>{nameFor(temperature)}</h2>
      <span>Adjust warmth through vertical motion.</span>
      <div
        className="environment-orb"
        style={
          {
            "--orb-glow": atmosphere.previewGlow,
            "--orb-motion": String(atmosphere.motionStrength),
          } as CSSProperties
        }
      >
        <i />
